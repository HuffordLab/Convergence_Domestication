...
Such parallelism in the grasses may have been more likely in species with high levels of genetic diversity.
Subsequent to domestication, many crops moved beyond the range of their wild progenitors, adapting to a number of novel environmental conditions.
However, eroded genetic diversity due to both demographic changes and selection during domestication reduced evolutionary potential for subsequent adaptation and potentially limited parallelism at this stage.
Here we review current knowledge regarding the extent of convergence and parallelism during domestication and adaptation in the grasses and consider whether the dynamism of grass genomes (e.g., transposable elements, polyploidy, genome size) has contributed to the likelihood of these phenomena.
\end{abstract}
...
Certain species of edible plants have been continually selected by humans over the last 10,000 years for traits including nutrition, yield, and other attractive features, a process that has also dramatically changed the physiology of these plants into the crops we are familiar with today.
...
Table \ref{tab:Ortho} collates examples of adaptation traits to domestication traits, where probable, using the definition of adaptation as described above. 
...
{\bf Domestication Trait} & {\bf In Cereal Crops} & {\bf In non-Cereal Crops} &	{\bf References} \\\toprule
...
Reduced defensive structures (spines, thorns) & yes & yes & \citep{Miller2011, Pickersgill2007, Hua2015}\\
...
\begin{tabular}{G{1.5cm}G{2.5cm}C{3.10cm}C{3.2cm}C{2.3cm}G{3.5cm}G{2.1cm}G{1.3cm}G{1.5cm}}
\\\toprule
{\bf Trait type} & {\bf Phenotypic trait} &{\bf Crop species} & {\bf Ortholog phylogeny} & {\bf Phylogeny of domestication trait} & {\bf Orthologous gene(s)} & {\bf Gene product} & {\bf Convergence} & {\bf References} \\\toprule
 ...
 domestication & Dwarfism &Wheat & Species & species-specific, grass & Rht-1 & SH2-TF & convergent & \citep{Doebley2006}\\
 ...
 domestication & Grain quality &Maize & Species & species-specific, grass & Opaque2 & bZIP-TF & convergent & \citep{Martin2013}\\
 ...
 both & Coloration &Blood orange & Species & species-specific, outside cereals & Ruby & MYB-TF & convergent & \citep{Butelli2012}\\
 both & Coloration &Rice & Species & species-specific, grass & Bh4 & Transporter protein & convergent & \citep{Zhu2011}\\
 both & Coloration &Soybean & Species & species-specific, outside cereals & R & MYB-TF & convergent & \citep{Gillman2011}\\
 both & Coloration &Rice & Species & species-specific, grass & Rc & bHLH-TF & convergent & \citep{Martin2013}\\
 both & Coloration &Grapevine & Species & species-specific, outside cereals & VvMYBA1-3 & MYB-TF & convergent & \citep{Martin2013}\\
 ...
 both & Flowering time &Rice & Species & species-specific, grass & Hd1 & Zinc finger TF & convergent & \citep{Martin2013}\\
 ...
 both & Plant architecture &Barley & Species & species-specific, grass & VRS1 & Homeodomain-TF & convergent & \citep{Martin2013}\\
 ...
 adaptation & Drought tolerance &Rice & Species & species-specific, grass & OsAHL1 & AT-hook PPC domain & convergent & \citep{Zhou2016}\\
 ...
 adaptation & Pathogen resistance &Maize & Species & species-specific, grass & Rp3 & NBS-LRR & convergent & \citep{pmid12242248}\\
