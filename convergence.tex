...
Inclusion of a subset of wild relative diversity and selection on particular alleles that code for desirable traits (such as those in the domestication syndrome) have caused a diversity of alleles to be lost during domestication and crop expansion, particularly when breeding populations have been small.
Loss of genetic diversity through these genetic bottlenecks can have consequences for adaptation.
...
The ways in which domestication has shaped the potential for adaptation in crops is the topic of this review.
