...
%While there has been some debate regarding the utility of distinguishing parallel and convergent traits because of X, Y, Z \citep{ARENDT2008}, we argue the distinction is useful in the grasses due to A, B, C.
...
However, the first three cases all rely on the retention of orthologous genes throughout evolution that have not undergone functional divergence.
Therefore, loss of certain orthologs prior to widespread crop domestication would make parallel domestication for some traits impossible.
...
But, to what extent can this knowledge help us to understand how domestication has impacted a crop's ability to adapt to new environments?  \mbh{Problems with the previous paragraph}
\paragraph{}
