...
The cereals also share a specific domestication phenotype whereby the end product is a millable grain.  \mbh{Need an expanded paragraph here on convergence in domestication syndrome traits in the grasses} 
 \mbh{need expanded discussion here connecting candidates to grass domestication syndrome traits mentioned in the previous paragraph and evaluating evidence for parallelism}

\mw{A number of domestication genes have been characterized in Table \ref{tab:Ortho}, a table which was originally featured in ~\citep{Lenser2013} and which we adapted and modified for this review. 
As shown in Figure \ref{fig:convergence}, orthology, or shared functional genes among species, is a type of parallelism of convergent traits. 
In Table \ref{tab:Ortho}, cereal domestication genes can be categorized as to whether they occur strictly within a species, share orthologs across the grasses, share orthologs within and outside of the grasses, or share orthologs entirely outside of the grasses, based on existing characterization of loci thought to play a role in domestication (Column 5, Table \ref{tab:Ortho}). 
This gives us an opportunity to form hypotheses regarding the likelihood of parallelism for a convergent domestication trait based on its known orthology across taxa. 
Domestication syndrome traits can include apical dominance or lack of branching, loss of seed dormancy, loss of bitterness, and loss of shattering or seed dispersal \citep{Lenser2013}. Other domestication traits can include fragrance \citep{Kellogg2001} and glutinous seeds \citep{Meyer2013}. }
